 ...
 */
public class CamWeatherSyncAdapter extends AbstractThreadedSyncAdapter {
    public final String LOG_TAG = CamWeatherSyncAdapter.class.getSimpleName();
    ...
    public CamWeatherSyncAdapter(Context context, boolean autoInitialize) {
...
// NotificationCompatBuilder is a very convenient way to build backward-compatible
    ...
    private static void onAccountCreated(Account newAccount, Context context) {
         ...
         */
        CamWeatherSyncAdapter.configurePeriodicSync(context, SYNC_INTERVAL, SYNC_FLEXTIME);
