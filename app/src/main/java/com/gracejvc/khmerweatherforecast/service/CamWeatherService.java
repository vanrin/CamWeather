package com.gracejvc.khmerweatherforecast.service;
...
/**
 * Created by Chhea Vanrin on 7/21/2015.
 */
public class CamWeatherService extends IntentService {
    private final String LOG_TAG = CamWeatherService.class.getSimpleName();
    static public final String LOCATION_QUERY_EXTRA = "lge";
    public CamWeatherService() {
        super("CamWeather");
    }
    ...
    public static class AlarmReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            Intent sendIntent = new Intent(context, CamWeatherService.class);
            sendIntent.putExtra(CamWeatherService.LOCATION_QUERY_EXTRA, intent.getStringExtra(CamWeatherService.LOCATION_QUERY_EXTRA));
